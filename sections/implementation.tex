...
\item Randomized SVD algorithm has the same order of algorithmic complexity but yet can help to significantly reduce execution time. (The implementation of the particular randomized SVD algorithm that was used is described in \cite{Halko2011}.)
\end{itemize}
